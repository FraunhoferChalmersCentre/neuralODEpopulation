...
if __name__ == "__main__":
    ...
    '--data_validation_path', 'lib/data/Simulated_ODE3_correlated_covariate_val.csv', 
    '--data_test_path', 'lib/data/Simulated_ODE3_uncorrelated_covariate_test.csv', 
    '--data_path', 'lib/data/Simulated_ODE3_correlated_covariate_train.csv',
    '--save_dir', 'models',
    '--load_dir', 'models']
