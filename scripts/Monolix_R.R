...
loadProject("C:/Users/MarcusBaaz/OneDrive - Fraunhofer-Chalmers Centre/NODE/neuralODEpopulation/monolix/FirstOrder.mlxtran")
# Change dataset path
...
files=c(0:(n_files1-1),50:(n_files2-1))
...
for(i in files){
  ...
  setData(
    file_path <- paste0("C:/Users/MarcusBaaz/OneDrive - Fraunhofer-Chalmers Centre/NODE/neuralODEpopulation/monolix_data_", i, ".csv"),
  ...
  file_path <- "C:/Users/MarcusBaaz/OneDrive - Fraunhofer-Chalmers Centre/NODE/neuralODEpopulation/monolix/FirstOrder/ChartsData/ObservationsVsPredictions/DV_obsVsPred.txt"
...
file_path <- "C:/Users/MarcusBaaz/OneDrive - Fraunhofer-Chalmers Centre/NODE/neuralODEpopulation/results_SAEM_First_Order.csv"

# Export as CSV
write.csv(results, file_path, row.names = FALSE)

# Define the full file path
file_path2 <- "C:/Users/MarcusBaaz/OneDrive - Fraunhofer-Chalmers Centre/NODE/neuralODEpopulation/residuals_SAEM_First_Order.csv"
...
loadProject("C:/Users/MarcusBaaz/OneDrive - Fraunhofer-Chalmers Centre/NODE/neuralODEpopulation/monolix/ZeroOrder.mlxtran")
# Change dataset path
...
for(i in files){
  ...
  # Construct file path for the current iteration
  file_path <- "C:/Users/MarcusBaaz/OneDrive - Fraunhofer-Chalmers Centre/NODE/neuralODEpopulation/monolix/ZeroOrder/ChartsData/ObservationsVsPredictions/DV_obsVsPred.txt"
...
# Define the full file path
file_path <- "C:/Users/MarcusBaaz/OneDrive - Fraunhofer-Chalmers Centre/NODE/neuralODEpopulation/results_SAEM_Zero_Order.csv"

# Export as CSV
write.csv(results, file_path, row.names = FALSE)

# Define the full file path
file_path2 <- "C:/Users/MarcusBaaz/OneDrive - Fraunhofer-Chalmers Centre/NODE/neuralODEpopulation/residuals_SAEM_Zero_Order.csv"
