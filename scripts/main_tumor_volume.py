...
if __name__ == "__main__":
  ...
  #  save_models(models, save_dir, "test1")
    ...
    train_loop_model(
       ...
       t_dense=t_dense,
       n_epochs=10000,
       warmup_epochs_noise=15,
       warmup_epochs_iiv=0,
       smoothing_start_epoch=15,
  ...
  #  save_models(models, save_dir, "test1")
    ...
    plot_encoder_histograms(
       ...
       dataset_train, train_loader, encoder_ae, latent_dim, device=None, truncation=truncation, normalization=True
   )
...
#     vpc_true(
#        models, dataset_train, t_dense, global_max_time, global_mean, global_std,
#        initial_encoder_ae, encoder_ae, func_ae, reducer_ae, noise_ae,
