# -*- coding: utf-8 -*-
"""
Created on Fri Aug 29 09:26:30 2025
...
if __name__ == "__main__":
    ...
    sys.argv = ['script_name',
                ...
                '--save_dir', 'models',
                '--load_dir', 'models/old',
                '--base_dir','results/run_simulated_data']
    
    
    from lib.utils.my_utils import prepare_datasets_and_loaders, run_model_variant, compute_global_stats, export_all_metrics_and_residuals, append_metrics, load_all_metrics_and_residuals_as_lists, TrajectoryDataset, collate_fn, ODEWrapper
