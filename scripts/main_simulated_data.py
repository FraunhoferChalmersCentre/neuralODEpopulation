...
if __name__ == "__main__":
    ...
    from lib.utils.utils_post_processing import  vpc_true, plot_single_model_encoders_and_regression , plot_encoder_histograms, plot_individual_fits
...
vpc_true(
models_norm=models_med,models_eval=models_ebvae,dataset= dataset_train, t_dense=t_dense, df=df,
...
plot_single_model_encoders_and_regression(
   ...
   truncation=truncation, use_ema_models=True, normalization=True
)
