...
#
# save_models(models_med, save_dir, "med")

# %%

load_models(models_med, save_dir, "med", device=device)
...
hidden_Encoder_dim=16
model_Encoder_dim=32
heads_Encoder=2
layers_Encoder=2
dropout_Encoder=0.001
learn_prior_mean=True
