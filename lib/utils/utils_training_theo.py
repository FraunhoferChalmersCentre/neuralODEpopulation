...
from lib.utils.utils_preprocess_theo import destandardize_concentration, collate_fn, truncate_time_series, append_metrics, export_all_metrics_and_residuals
from lib.utils.utils_post_processing_theo import vpc_true, vpc, plot_individual_fits, compute_residuals
...
def run_model_variant(dim_parameter_encoder, variant_name, dataset_train, dataset_val, dataset_test,
   ...
   # # mse_mean, r2_mean, mse_median, r2_median, res_df = #
    plot_individual_fits(dataset_train,
        latent_dim, combined, models, train_loader, device,
        global_mean, global_std, global_max_time,
    ...
    compute_residuals(dataset_train, latent_dim, global_mean, global_std, global_max_time, func, encoder, reducer, initial_encoder, noise, train_loader, combined, device, 0.35)
   ...
   global_mean, global_std, global_max_time,
   enable_nf, enable_ae, enable_onlymedian,combined,
   truncation=truncation
    )
